    ...
    <Layout preview={false} title={'マイページ'} desc={'マイページ'} >
      <Container>
        <BreakpointContainer>
          {user ? (<>
            <Box>
              <Heading as="h1" mb={6} fontStyle="h1">マイページ</Heading>
            ...
            <Divider my={8} />
            <Heading as="h2" fontStyle="h2" mb={4}>プロフィール設定</Heading>
            <Box mb={8}>
              <Warning />
              <Formik
                initialValues={{
                ...
                {({ handleSubmit, values }) => (
                  <Stack as="form"
                    ...
                    <RadioGroupControl name="photoURL" label="プロフィール画像">
                      <Box><Radio value="1"></Radio><img width={64} src={actualPhotoUrl(1)} /></Box>
                      <Box><Radio value="2"></Radio><img width={64} src={actualPhotoUrl(2)} /></Box>
                      <Box><Radio value="3"></Radio><img width={64} src={actualPhotoUrl(3)} /></Box>
                    </RadioGroupControl>
