...
const HeroWithThumbnails = ({ totalCount }: Props) => (
  <Box overflow="hidden" position="relative" background="linear-gradient(344deg, rgba(38,135,232,0.6320903361344538) 0%, rgba(58,199,227,0.4248074229691877) 100%)" mb={8} w="full" color="white">
